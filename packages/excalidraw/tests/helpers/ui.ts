...
// flow: the harness targets the real border segment resizeTest walks (see the
// isSideHandle branch below); getSelectionBorders is exported for that purpose.
import { getSelectionBorders } from "@excalidraw/element";
